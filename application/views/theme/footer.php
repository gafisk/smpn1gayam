            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <img width="150" src="<?php echo base_url(''); ?>style/img/footer_logo1.png" class="rounded
                            alt=" SMPN 1 GAYAM">
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-3">
                    ...
                    <div class="footer_widget">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p>galihrestubaihaqi@gmail.com</p>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <p>
                        ...
                        </script> <a href="https://suryaciptainformatika.com/" target="_blank">SMPN 1 GAYAM SAPUDI</a>
                    </p>
                    </p>
                </div>
            </div>
