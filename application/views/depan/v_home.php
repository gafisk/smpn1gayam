                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="slider_text ">
                            <h1 style="font-weight: bold; font-size: 60px;" class="text-center text-white">SMP NEGERI 1
                                GAYAM</h1>
                            <h2 style="font-weight: bold;font-size: 40px;" class="text-center text-white">Kec. Gayam
                                Kab.
                                Sumenep Jawa
                                Timur </h2>
                        </div>
        ...
        <div class="single_slider  d-flex align-items-center slider_bg_2">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="slider_text ">
                            <h2 style="font-weight: bold;font-size: 40px;" class="text-center text-white">Jl. Kebunan -
                                Gayam - Sapudi <br> Telp. 0327 - 811017
                                <br> SUMENEP
                            </h2>
                        </div>
                    </div>
